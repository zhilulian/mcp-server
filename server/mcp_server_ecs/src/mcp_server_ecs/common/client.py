...
def get_volc_ecs_client() -> ECSApi:
    ...
    if _ecs_client is None:
        ...
        ecs_config.ak = os.environ.get("VOLC_ACCESSKEY") or auth_config.get("ak")
        ecs_config.sk = os.environ.get("VOLC_SECRETKEY") or auth_config.get("sk")
        ecs_config.region = os.environ.get("VOLC_REGION") or auth_config.get("region")
        ecs_config.host = os.environ.get("VOLC_ENDPOINT") or auth_config.get("host")
