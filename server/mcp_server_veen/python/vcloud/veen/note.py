note = {
    "start_cloud_server": """Args:""",
    "delete_cloud_server": """Args:""",
    "stop_cloud_server": """Args:""",
    "reboot_cloud_server": """Args:""",
    "create_cloud_server": """Args:body: A JSON structure
...
字段： DataDiskList
 ...
 capacity (String): 是  磁盘容量。单位：GB。容量范围： 
       ...
       - 数据云盘：20 ~ 1000。 
       取值须是 10 的倍数。如需更大磁盘容量，请提交工单申请。""",
    "update_cloud_server": """Args:body: A JSON structure
...
字段： DataDiskList
 ...
 capacity (String): 是  磁盘容量。单位：GB。容量范围： 
       ...
       - 数据云盘：20 ~ 1000。 
       取值须是 10 的倍数。如需更大磁盘容量，请提交工单申请。""",
    "get_cloud_server": """Args:params: A JSON structure
     cloud_server_id (String): 是  边缘服务 ID。您可以通过 ListCloudServers 接口查询边缘服务 ID。""",
    "reboot_instances": """Args:body: A JSON structure
     instance_identities (Array of String): 是  边缘实例 ID 列表。您可以通过 ListInstances 接口查询边缘实例 ID。""",
    "start_instances": """Args:body: A JSON structure
     instance_identities (Array of String): 是  边缘实例 ID 列表。您可以通过 ListInstances 接口查询边缘实例 ID。""",
    "stop_instances": """Args:body: A JSON structure
     instance_identities (Array of String): 是  边缘实例 ID 列表。您可以通过 ListInstances 接口查询边缘实例 ID。""",
    "list_instances": """Args:params: A JSON structure
 ...
 order_by (Integer): 否  查询出来的边缘实例的排列顺序，按照创建时间排序。取值范围： 
       - 1（默认值）：按照降序排列。 
       - 2：按照升序排列。""",
    "get_instance": """Args:params: A JSON structure
     instance_identity (String): 是  边缘实例 ID。您可以通过 ListInstances 接口获取边缘实例 ID。""",
    "reset_login_credential": """Args:body: A JSON structure
     instance_identity (String): 是  边缘实例 ID。您可以通过 ListInstances 接口查询边缘实例 ID。""",
    "set_instance_name": """Args:body: A JSON structure
     instance_identity (String): 是  边缘实例 ID。您可以通过 ListInstances 接口查询边缘实例 ID。 
 instance_name (String): 是  实例名称。命名规则如下： 
       ...
       - 支持特殊字符()`~!@#$%^&*-+=_{}[]:;',.?/。 
       - 不能包含双引号（"）、反斜线（ ）和空格，且不能以正斜线（/）开头。""",
    "batch_reset_system": """Args:body: A JSON structure
     instance_identities (Array of String): 是  边缘实例 ID 列表。您可以通过 ListInstances 接口查询边缘实例 ID。 
 image_identity (String): 否  新镜像的 ID。您可以通过 ListImages 接口查询镜像 ID。 
       该参数用于为边缘实例更换镜像。如果您不指定该参数的值，代表不更换边缘实例的镜像。""",
    "set_instances_bandwidth_peak": """Args:body: A JSON structure
 ...
 with_reboot (Boolean): 是  是否重启实例。取值范围： 
    ...
    "enable_instances_i_pv6": """Args:body: A JSON structure
     instance_identities (Array of String): 是  边缘实例 ID 列表。您可以通过 ListInstances 接口查询边缘实例 ID。 
 with_reboot (Boolean): 是  是否重启实例。取值范围： 
       - true：重启实例。 
       - false：不重启实例。 
       说明：  
       重启实例后，IPv6 的配置才能生效。""",
    "get_instances_i_pv6_upgrade_status": """Args:params: A JSON structure
     instance_identities (String): 是  边缘实例 ID 列表。ID 之间用半角逗号（,）分隔。""",
    "update_instances_spec": """Args:body: A JSON structure
     instance_identities (Array of String): 是  边缘实例 ID 列表。您可以通过 ListInstances 接口查询边缘实例 ID。 
 new_spec_name (String): 是  新的实例规格的名称。您可以通过 ListInstanceTypes 接口查询可开通的实例规格。""",
    "list_instance_internal_ips": """Args:params: A JSON structure
     instance_identity (String): 是  边缘实例 ID。您可以通过 ListInstances 接口查询边缘实例 ID。""",
    "set_bound_eip_share_bandwidth_peak": """Args:body: A JSON structure
     instance_identity (String): 是  边缘实例 ID。您可以通过 ListInstances 接口查询边缘实例 ID。 
 bound_eip_share_bandwidth_peak (String): 是  弹性公网 IP 的共享带宽峰值。取值范围与弹性公网 IP 绑定的边缘实例的公网带宽峰值的范围一致。取值须是 5 的倍数。单位：Mbps。""",
    "batch_bind_eip_to_internal_ips_randomly": """Args:body: A JSON structure
     instance_identity (String): 是  边缘实例 ID。您可以通过 ListInstances 接口查询边缘实例 ID。 
 internal_ips (Array of String): 是  需要绑定的私网 IP 地址的列表。您可以通过 ListInstanceInternalIps 接口查询边缘实例的私网 IP 地址。""",
    "batch_delete_internal_ips": """Args:body: A JSON structure
     instance_identity (String): 是  边缘实例 ID。您可以通过 ListInstances 接口查询边缘实例 ID。 
 internal_ips (Array of String): 是  私网 IP 地址列表。您可以通过 ListInstanceInternalIps 接口查询边缘实例的私网 IP 地址。""",
    "get_instance_cloud_disk_info": """Args:params: A JSON structure
     instance_identity (String): 是  边缘实例 ID。您可以通过 ListInstances 接口查询边缘实例 ID。""",
    "set_cloud_server_delete_protection": """Args:body: A JSON structure
 ...
 cloud_server_delete_protection (Boolean): 否  是否为边缘服务开启删除保护。取值范围： 
       - true：开启删除保护。 
       - false：关闭删除保护。""",
    "set_instance_delete_protection": """Args:body: A JSON structure
 ...
 instance_delete_protection (Boolean): 否  是否为边缘实例开启删除保护。取值范围： 
       - true：开启删除保护。 
       - false：关闭删除保护。""",
    "list_cloud_servers": """Args:params: A JSON structure
 ...
 order_by (Integer): 否  查询出来的边缘服务的排列顺序，按照创建时间排序。取值范围： 
       - 1（默认值）：按照降序排列。 
       - 2：按照升序排列。""",
    "list_instance_types": """Args:""",
    "list_available_resource_info": """Args:params: A JSON structure
     instance_type (String): 是  实例规格。您可以通过 ListInstanceTypes 接口获取可开通的实例规格。 
 cloud_disk_type (String): 是  磁盘类型。取值范围： 
       - CloudHDD：HDD 型云盘。 
       - CloudSSD：SSD 型云盘。""",
    "create_instance": """Args:body: A JSON structure
...
字段： InstanceAreaNums
 ...
 property (String): 否  镜像属性，取值范围： 
    ...
    "get_image": """Args:params: A JSON structure
     image_id (String): 是  镜像 ID。您可以通过 ListImages 接口查询镜像 ID。""",
    "build_image_by_vm": """Args:body: A JSON structure
 ...
 description (String): 否  镜像的描述信息。""",
    "upload_url_image": """Args:body: A JSON structure
     image_name (String): 是  镜像名称。命名规则如下： 
       - 允许 5~80 个字符。 
       - 支持中文、大写字母、小写字母、数字。 
       - 支持特殊字符 ()`~!@#$%^&*-+=_{}[]:;',.?/。 
 ...
 description (String): 否  镜像的描述信息。""",
    "update_image": """Args:body: A JSON structure
     image_id (String): 是  镜像 ID。 
 image_name (String): 否  镜像名称。 
 description (String): 否  镜像的描述信息。""",
    "delete_image": """Args:body: A JSON structure
     image_id (String): 是  镜像 ID。您可以通过 ListImages 接口查询镜像 ID。""",
    "get_veen_instance_usage": """Args:params: A JSON structure
 ...
 bill_method (String): 否  计费方式，取值范围： 
    ...
    "get_veew_instance_usage": """Args:params: A JSON structure
     start_bill_cycle (String): 是  账单的起始时间。格式为 YYYY-MM。 
 end_bill_cycle (String): 是  账单的结束时间。格式为 YYYY-MM。 
 bill_method (String): 否  计费方式，取值范围： 
       - MonthlyPeak（默认值）：按月峰值计费。 
       - DailyPeak：按日峰值计费。如您有日峰值计费或其他方式计费需求，请提交工单。""",
    "get_bandwidth_usage": """Args:params: A JSON structure
     start_bill_cycle (String): 是  账单的起始时间。格式为 YYYY-MM。 
 end_bill_cycle (String): 是  账单的结束时间。格式为 YYYY-MM。 
 bill_method (String): 否  计费方式，取值范围： 
       - MonthlyP95（默认值 ）：按月 95 峰值计费。 
       - DailyPeak：按日峰值计费。如您有日峰值计费或其他方式计费需求，请提交工单。""",
    "get_billing_usage_detail": """Args:params: A JSON structure
 ...
 bill_method (String): 否  计费方式，取值范围： 
       - *MonthlyPeak *（默认值）：按月峰值计费。 
       - DailyPeak：按日峰值计费。如您有日峰值计费或其他方式计费需求，请提交工单。""",
    "list_vpc_instances": """Args:params: A JSON structure
 ...
 with_resource_statistic (Boolean): 否  是否返回私有网络下的资源的统计数据。取值范围： 
       - true：返回资源的统计数据。 
       - false：不返回资源的统计数据。""",
    "set_vpc_instance_desc": """Args:body: A JSON structure
     vpc_identity (String): 是  私有网络的 ID。 
 desc (String): 否  私有网络的描述。如果不指定该参数或参数值为空字符串，原来的描述将被清空。""",
    "list_route_tables": """Args:params: A JSON structure
 ...
 order_by (Integer): 否  查询出来的路由表的排列顺序，按照创建时间排序。取值范围： 
       - 1（默认值）：按照降序排列。 
       - 2：按照升序排列。""",
    "get_route_table": """Args:params: A JSON structure
     route_table_identity (String): 是  路由表 ID。您可以通过 ListRouteTables 接口获取路由表 ID。""",
    "set_route_table_name_and_desc": """Args:body: A JSON structure
     route_table_identity (String): 是  路由表 ID。您可以通过 ListRouteTables 接口获取路由表 ID。 
 ...
 desc (String): 否  路由表描述。 
       如果不指定该参数，系统将保留原来的描述。""",
    "list_route_entries": """Args:params: A JSON structure
     route_table_identity (String): 是  路由表 ID。您可以通过 ListRouteTables 接口获取路由表 ID。 
 ...
 order_by (Integer): 否  查询出来的路由条目的排列顺序，按照创建时间排序。取值范围： 
       - 1（默认值）：按照降序排列。 
       - 2：按照升序排列。""",
    "create_route_entries": """Args:body: A JSON structure
     route_table_identity (String): 是  路由表 ID。您可以通过 ListRouteTables 接口获取路由表 ID。 
...
字段： RouteEntryList
 ...
 is_enable (Boolean): 是  是否启用路由条目。取值范围： 
       - true：启用路由条目。 
       - false：不启用路由条目。""",
    "delete_route_entry": """Args:body: A JSON structure
     route_table_identity (String): 是  路由表 ID。您可以通过 ListRouteTables 接口获取路由表 ID。 
 route_entry_identity (String): 是  路由条目 ID。您可以通过 ListRouteEntries 接口获取路由条目 ID。""",
    "enable_route_entry": """Args:body: A JSON structure
     route_table_identity (String): 是  路由表 ID。您可以通过 ListRouteTables 接口获取路由表 ID。 
 route_entry_identity (String): 是  路由条目 ID。您可以通过 ListRouteEntries 接口获取路由条目 ID。""",
    "disable_route_entry": """Args:body: A JSON structure
     route_table_identity (String): 是  路由表 ID。您可以通过 ListRouteTables 接口获取路由表 ID。 
 route_entry_identity (String): 是  路由条目 ID。您可以通过 ListRouteEntries 接口获取路由条目 ID。""",
    "set_route_entry_desc": """Args:body: A JSON structure
     route_table_identity (String): 是  路由表 ID。您可以通过 ListRouteTables 接口获取路由表 ID。 
 route_entry_identity (String): 是  路由条目 ID。您可以通过 ListRouteEntries 接口获取路由条目 ID。 
