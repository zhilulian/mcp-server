...
| 版本 |         v1.0.0          |
|:--: |:-----------------------:|
| 描述 | 资源项目（Project）是火山引擎提供的一种资源分组管理的机制，帮助您达成逻辑层面的资源隔离，您能够通过资源项目进行项目制授权和分账等操作。       |
| 分类 | 工具类 |
| 标签 | 项目、管理与治理           |
...
- ListProjectIdentities: 获取项目身份实体列表
...
## 服务开通链接
https://console.volcengine.com/iam/resourcemanage/project
...
- /ABSOLUTE/PATH/TO/PARENT/FOLDER
   - mcp-server-project 的代码库目录，例如 /Users/xxx/mcp-server/server/mcp_server_project，对应 https://github.com/volcengine/mcp-server/tree/main/server/mcp_server_project
...
```json
{
    "mcpServers": {
        "project": {
            ...
            "args": [
                "--from",
                "git+https://github.com/volcengine/mcp-server#subdirectory=server/mcp_server_project",
                "mcp-server-project"
            ],
            "env": {
                "VOLCENGINE_ACCESS_KEY": "your ak",
...
```shell
uv --directory /ABSOLUTE/PATH/TO/PARENT/FOLDER run mcp-server-project
```
